...
pub const MAX_INVESTOR_ALLOWLIST_BATCH: usize = 32;
...
pub enum EscrowError {
    ...
    PayoutZero = 166,
    AttestationNotRevoked = 167,
    FundingDeadlineUpdateNotOpen = 168,
    MaturityInPast = 169,
    MaturityExceedsMaxHorizon = 170,
    NotInitialized = 171,
    NoCollateralToClear = 172
}
